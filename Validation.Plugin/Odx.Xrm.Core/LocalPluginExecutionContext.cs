...
namespace Odx.Xrm.Core
{
    internal class LocalPluginExecutionContext : ILocalPluginExecutionContext
    {
        ...
        public bool HasPreImage => Context.PreEntityImages.Contains(nameof(this.PreImage));

        public bool HasPostImage => Context.PostEntityImages.Contains(nameof(this.PostImage));
